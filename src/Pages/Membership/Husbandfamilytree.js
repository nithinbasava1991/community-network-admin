    ...
    const fetchFamilyTree = async () => {
      if (rowData) {
        try {
          ...
          // Filter data to get only husband's side
          const husbandSideData = data.filter(member => member.gender === "MALE");
          setFamilyTreeData(husbandSideData);
        } catch (error) {
...
export default HusbandFamilyTree;
